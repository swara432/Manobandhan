				...
				<nav class="nav navbar-default" style="background-color:#AA3535;  width: 100%;">
					<div class="container-fluid">
						<ul class="nav navbar-nav" style="font-family:'#44 Font'; margin-left: 20%;">  <!----Center--->
							<li ><a href="home.php" style="color: white; margin-left: 300px;"><img src="images/logo/logo.png" alt="Marital" height="25"/></a></li>
                        </ul>            
					</div>
				</nav>
           </div>     
                      ...
                      <div id="myTabContent" class="tab-content">           
                         ...
                         <!----------Personal Information form----------------->
                            ...
                            <div class="form-group row" style="margin-top: 5px;">
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="ManageBy" />
                                </div>
                              </div>                                                                           
                              <div class="form-group row" style="margin-top: 5px;">
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="MStatus" />
                                </div>
                              </div>
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="LanguageKnown" />
                                </div>
                              </div>
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="MotherTounge" />
                                </div>
                              </div>
                               <div class="form-group row" >
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="Smoke" />
                                </div>
                              </div>
                         ...
                         <div role="tabpanel" id="Family" aria-labelledby="Family-tab" class="tab-pane fade" >
                         ...
                         <form action="ProfileServlet" method="post">                                                                                 
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="Brother" />
                                </div>
                              </div>
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="Sister" />
                                </div>
                              </div>
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="Uncle" />
                                </div>
                              </div>
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="Uncle(Maternal)" />
                                </div>
                              </div>
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="Aunt" />
                                </div>
                              </div>
                         ...
                         <div role="tabpanel" id="Astro" aria-labelledby="Astro-tab" class="tab-pane fade">
                         ...
                         <form action="ProfileServlet" method="post" >     
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="Manglik" />
                                </div>
                              </div>
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="Devak" />
                                </div>
                              </div>
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="Gaan" />
                                </div>
                              </div>                            
                         ...
                         <div role="tabpanel" id="Partner" aria-labelledby="Partner-tab" class="tab-pane fade">
                                <!----------Partner Prefrence form----------------->
                         <form action="ProfileServlet" method="post">                                                                                 
                              <div class="form-group row" style="margin-top: 5px;">
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="JobSpecification " />
                                </div>
                              </div> 
                               <div class="form-group row" >
                                <label for="AnnualIncome" class="col-sm-2 col-form-label">Annual Income </label>      <!----------Annual Income---------->
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="AnnualIncome" />
                                </div>
                              </div>  
                              <div class="form-group row" >
                                <label for="Complexion" class="col-sm-2 col-form-label">Complexion </label>       <!----------Complexion---------->
                              ...
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="CountryOfResidence" />
                                </div>
                              </div>
                              <div class="form-group row" >
                                ...
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="MartialStatus" />
                                </div>
                              </div>
                              ...
                              <label for="ResidenceStatus" class="col-sm-2 col-form-label">Residence Status </label>      <!----------residence status ---------->
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" id="ResidenceStatus" />
                                </div>
                              </div> 
