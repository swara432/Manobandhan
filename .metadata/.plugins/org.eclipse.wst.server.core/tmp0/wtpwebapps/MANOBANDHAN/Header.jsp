...
<body>
	<div class="row">
			<div class="col-lg-12 col-sm-12 col-md-12" >
				<nav class="nav navbar-default navbar-fixed-top" style="background-color:#AA3535;  width: 100%;">
					<div class="container-fluid">
						<ul class="nav navbar-nav navbar-left" style="font-family:'#44 Font';"><!----left--->
                            ...
                            <li ><a href="upgrade.jsp" style="color: white;">Premium</a></li>
						...
						<ul class="nav navbar-nav" style="font-family:'#44 Font'; margin-left: 20%;">  <!----Center--->
		                 ...
		                 <ul class="nav navbar-nav navbar-right" style="font-family:'#44 Font'; margin-right: 10px; margin-top: 4px;">  <!----right--->                                                        							
							<li><a href="logout.jsp" data-toggle="modal" data-target="#Login_model" style="color: white;"></span>My Profile</a></li>
								<!-- <li><a href="logout.jsp" data-toggle="modal" data-target="#Login_model" style="color: white;"></span>Log Out</a></li> -->
